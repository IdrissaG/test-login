...
<div class="main-content">
    <main>
        <ul class="lu">
            <li class="lis"><a href="paiement.php">Paiement</a></li>
            ...
            <div class="results">
                ...
                <table class="student-table">
                    ...
                    <tbody>
                        ...
                        if ($etudiant) {
                            $req5=$connexion->query("SELECT * FROM classe WHERE id_classe='$id_classe'");
                            $result=$req5->fetch();
                            $req6=$connexion->query("SELECT * FROM niveau WHERE id_niveau='$id_niveau'");
                            $result2=$req6->fetch();
                            while ($ligne = $etudiant->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result2['nom_niveau']; ?></td>
                                    <td><?php echo $ligne['montant_paiement']; ?></td>
                                    <td><a href="editer_paiement.php?id_etudiant=<?php echo $ligne['id_etudiant'];?>"><i class='bx bx-edit'></i></i></a></td>
                                    <td><a href="releve_paiement.php?id_etudiant=<?php echo $ligne['id_etudiant'];?>"><i class='bx bx-book-content'></i></i></a></td>
                                </tr>
                                <?php
                            }
                        }
