...
<div class="main-content">
    <main>
        <ul class="lu">
            <li class="lis"><a href="note_classe.php">Recherche Classe</a></li>
            <li class="lis"><a class="nav_link" href="notes.php">Recherche Matiere</a></li>
        </ul>
                        ...
                        if ($etudiant) {
                            while ($ligne = $etudiant->fetch()) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="editer_note.php?id_etudiant=<?php echo $ligne['id_etudiant']; ?>&id_matiere=<?php echo $ligne['id_matiere'];?>"><i class='bx bx-edit'></i></a></td>
                                    <td><a href="releve_note.php?id_etudiant=<?php echo $ligne['id_etudiant']; ?>&id_matiere=<?php echo $ligne['id_matiere']; ?>"><i class='bx bx-book-content'></i></i></a></td>
                                </tr>
                                <?php
                            }
                        }
